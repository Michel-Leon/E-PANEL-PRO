...
Sub MostrarTodasLasHojas()
    ...
    Do
        ...
        Else
            If intentos >= MAX_INTENTOS Then
                ...
                Exit Sub
            End If
            MsgBox "Usuario o contrase�a incorrectos." & vbNewLine & _
    ...
    MsgBox "Acceso concedido. Todas las hojas est�n visibles.", vbInformation, "Listo"
End Sub
...
Public Sub Cerrar_seccion()
    ...
    ' 3) Borrar el usuario de la sesi�n
    wsConfig.Range("K193").ClearContents

    ' 4) DESPU�S ocultar INICIO (ya hay otra hoja visible)
...
Sub CambiarZoomEnTodasLasHojas()
    ...
    ' Cancelar si el usuario presiona Cancelar o deja vac�o
    ...
    ' Validar que el zoom est� dentro de un rango razonable
